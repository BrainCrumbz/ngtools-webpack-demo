/* tslint:disable */
import {
    Component, OnChanges, Directive, Input, Output, ComponentFactoryResolver, ViewContainerRef,
    ElementRef, ComponentRef, EventEmitter, OnInit, OnDestroy, ViewChild
} from '@angular/core';
...
@Component({
    ...
    styleUrls: ['./templates/default/color-picker.component.css'],
})
export class DialogComponent implements OnInit {
    ...
    setDialog(instance: ColorPickerDirective, elementRef: ElementRef, color: any, cpPosition: string, cpPositionOffset: string,
